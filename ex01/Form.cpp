...
/*   Updated: 2022/08/24 21:08:37 by agrotzsc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

Form::Form(void) : _name(""), _sign(false), _s_grade(150), _e_grade(150)
{
...
std::ostream &operator << (std::ostream& out, const Form &b)
{
	out << "Form " << b.getName() << " has a sign grade of " << b.get_S_Grade() \
		...
		(b.getIsSigned() ? " and is signed." : " and is unsigned.") << std::endl;
	return(out);
}
